...
config.nuve.port = 3000
config.nuve.address = "http://localhost:" + config.nuve.port + "/"
config.nuve.dataBaseURL = "localhost/nuvedb";
config.nuve.superserviceID = '5366a83287b6da84b6718825';
config.nuve.superserviceKey = '31398';
